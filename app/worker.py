...
def celery_on_startapp(*args, **kwargs):
...
beat_init.connect(celery_on_startapp)
worker_process_init.connect(celery_on_startapp)
...
def random_task(name):
    print(f"Who threw that shoe? Honestly {name}")
